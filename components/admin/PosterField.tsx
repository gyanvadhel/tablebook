        ...
        <div className="flex-1 min-w-0 flex flex-col gap-2">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              onClick={pick}
              disabled={disabled || isUploading}
              className="flex items-center gap-1.5 px-3 py-1.5 border border-slate-300 rounded-lg text-slate-700 hover:bg-slate-50 font-semibold disabled:opacity-50 transition"
            >
            ...
            {value && (
              <button
                ...
                disabled={disabled || isUploading}
                className="flex items-center gap-1.5 px-3 py-1.5 border border-rose-200 rounded-lg text-rose-700 hover:bg-rose-50 font-semibold disabled:opacity-50 transition"
              >
